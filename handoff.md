...
- All functional live-path evidence is complete: Round #1 settled confidential obligations end to end, and Round #2 expired and refunded all three participants. Browser-plugin and Playwright visual automation remain unavailable in this workspace; retain the user-captured screenshots as the browser-wallet proof.
...
1. Record the four-minute-or-shorter video and keep local offline copies of it and the screenshots.
2. Verify a clean public-repository clone/install and prepare the tagged X post.
